...
class Usuario {
  ...
  public function update() {
    ...
    $update = "UPDATE usuario SET nomUsu ='$this->nomUsu'"
        ...
        . ", passUsu ='$this->passUsu', permisoUsu ='$this->permisoUsu'"
  ...
  public static function getUsuarios() {
    ...
    while ($registro = $consulta->fetchObject()) {
      $usuarios[] = new Usuario($registro->codUsu, $registro->nomUsu, $registro->emailUsu, 
          $registro->catUsu, $registro->loginUsu, $registro->passUsu, $registro->permisoUsu);
    }
    return $usuarios;   
  }
